...
import { faHome, faArrowRightFromBracket,faEnvelope,faArrowUpFromBracket, faBars, faGraduationCap, faUser, faUsers, faFileCircleCheck  } from '@fortawesome/free-solid-svg-icons';
...
const StudentPage = () => {
  ...
  return (
   ...
   <div style={{
        ...
        {
          sidebarOpen &&(
            <div style={{display: 'flex', flexDirection: 'column',backgroundColor:"#929AA3", border:"1px solid black", borderTop:"none", flexGrow:"1", width:"12rem",}}>
                <button
              style={{
                height:"3rem",
                padding: '0.5rem',
          ...
          style={{cursor:"pointer" , fontSize:"2.5rem",color:"black" }} /> HomePage
            </button>
            <button
              style={{
                height:"3rem",
            ...
            >
              <FontAwesomeIcon icon={faEnvelope }
               style={{cursor:"pointer" , fontSize:"2.5rem",color:"black" }} /> Messages
            </button>
            <button
              style={{
                height:"3rem",
  ...
  style={{cursor:"pointer" , fontSize:"2.5rem",color:"black" }} /> Upload
            </button>
            <button
              style={{
                height:"3rem",
            ...
            >
                <FontAwesomeIcon icon={faArrowRightFromBracket } onClick={handleClick}  style={{cursor:"pointer" , fontSize:"2.5rem",color:"black" }} /> Logout
            </button>
      ...
      <p
            ...
            >Dear Students,
            <br />
            Internship regardless of your current education
            level or desired career path; It is very
            important for your professional development and
            acquiring new skills. As Üsküdar University, we
            wish success to all our students in this
            process.
          </p>
